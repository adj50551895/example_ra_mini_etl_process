...
import core.load_source_data_databricks as load_source_data_databricks
import core.load_dimension_data_databricks as load_dimension_data_databricks
...
df_sourceEnterpriseDimOrgEducation = load_source_data_databricks.get_source_enterprise_dim_org_education_raw()
df_sourceEntMemberLicenseDelegation = load_source_data_databricks.get_source_ent_member_licence_delegation_raw()
df_sourceEdexMemberSegmentationExtract = load_source_data_databricks.get_source_edex_member_segmentation_extract_raw()


# EdEx
# Dimensions
#df_dimEduMemberSegmentation = load_dimension_data_hadoop.get_dim_edu_member_segmentation()
df_dimEnterpriseDimOrgEducation = load_dimension_data_databricks.get_dim_enterprise_dim_org_education()
df_dimEntMemberLicenseDelegation = load_dimension_data_databricks.get_dim_data_ent_member_licence_delegation()
df_dimEdexMemberSegmentationExtract = load_dimension_data_databricks.get_dim_data_edex_member_segmentation_extract()

select t.fiscal_yr_and_per,
       ...
       t.pod as "Pod",
       */
       ifnull((select distinct d.priority_institution from edx.district_domains_hed d where d.district_id = t.district_id), 0) as priority_institution,
       -- (select distinct d.nces_id from edx.district_domains_hed d where d.district_id = t.district_id) as NCES_ID,
...
and t.isCurrent = 1
and exists (select 1 from edx.district_domains d where d.district_id = t.district_id and d.domain_class = 'HED')
